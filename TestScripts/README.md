...
`Runtime` 1658 / 0, `Platform` 1363 / 0, `AdminJest` 1345 / 7 known-red
(5 red suites; nine cases were fixed on 2026-09-21 - one **real defect** (missing admin menu icon
mappings for `hdd`/`key`), one flaky suite calibrated (`jest.setTimeout`), and seven test-lag cases;
see `known-red-dispositions.md`).
