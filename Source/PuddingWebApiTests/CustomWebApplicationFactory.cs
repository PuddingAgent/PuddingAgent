...
public sealed class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.RemoveAll<ILlmInvocationService>();
            services.AddSingleton<ILlmInvocationService, NoOpLlmInvocationService>();
    ...
    protected override void Dispose(bool disposing)
    {
        if (disposing)
        {
            ...
            Environment.SetEnvironmentVariable("PUDDING_DATA_ROOT", _previousDataRoot);
        }
    ...
    {
        RemoveHostedService<CronSchedulerService>(services);
    }
        ...
        var descriptors = services
            .Where(d => d.ServiceType == typeof(IHostedService)
                        && (d.ImplementationType == typeof(THostedService)
                            || d.ImplementationInstance?.GetType() == typeof(THostedService)
                            || d.ImplementationFactory?.Method.ReturnType == typeof(THostedService)))
            .ToList();
    ...
    private sealed class NoOpLlmInvocationService : ILlmInvocationService
    {
