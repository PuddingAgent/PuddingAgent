...
public partial class MainWindowViewModel : ViewModelBase
{
    ...
    public MainWindowViewModel()
    {
        ...
        PuddingLogger.Info("=== PuddingAssistant Desktop starting ===");
        ...
        AddSystemMessage("PuddingAssistant Desktop v0.1.0");
        if (Providers.Count == 0)
            AddSystemMessage("No providers configured. Run PuddingAssistantCLI first to set up ~/.pudding/config.json");
        else
        {
    ...
    private async Task SendMessageAsync()
    {
        ...
        if (ActiveProvider is null)
        {
            ...
            AddChat(ChatEntryKind.Error, "No provider configured. Run PuddingAssistantCLI to set up.");
            return;
        }
