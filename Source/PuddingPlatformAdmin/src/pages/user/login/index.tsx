...
const useStyles = createStyles(() => ({
  ...
  ambientBackdrop: {
    ...
    '&::before': {
      ...
      filter: 'saturate(0.68) brightness(1.07) blur(0.6px)',
    ...
    '&::after': {
      ...
      background: `
        linear-gradient(
          90deg,
          rgba(248, 244, 237, 0.76) 0%,
          rgba(248, 244, 237, 0.88) 48%,
  ...
  shell: {
    ...
    display: 'grid',
    gridTemplateColumns: 'minmax(0, 0.95fr) 400px',
    gap: 64,
    alignItems: 'center',
    position: 'relative' as const,
    zIndex: 2,
        ...
        <section className={styles.panelWrap} aria-label="登录">
          ...
          >
            <div className={styles.panelHeader}>
              ...
              <h2 className={styles.panelTitle}>登录 PuddingAgent</h2>
