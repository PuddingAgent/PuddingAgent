    ...
    [
      {
        ...
        label: '复制',
        disabled: false,
        onClick: () => callbacks.onCopy(turnId),
      },
      {
        icon: <MessageOutlined />,
        label: '引用回复',
        disabled: false,
        onClick: () => callbacks.onQuote(turnId),
      },
      ...(callbacks.onPin
        ? [
            {
              icon: <PushpinOutlined /> as React.ReactNode,
              label: '钉住',
              disabled: false,
              onClick: () => callbacks.onPin?.(turnId),
            },
          ]
        : []),
      {
        ...
        label: '删除',
        disabled: false,
        onClick: () => callbacks.onDelete(turnId),
      },
      {
        icon: <SoundOutlined />,
        label: '朗读',
        disabled: false,
        onClick: () => callbacks.onSpeak?.(turnId),
      },
    ],
    [
      {
    ...
    [
      {
        ...
        label: '从这里创建分支',
        disabled: false,
        onClick: () => callbacks.onBranch(turnId),
      },
    ],
  ];
  return items;
