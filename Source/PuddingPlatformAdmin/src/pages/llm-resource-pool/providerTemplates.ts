    ...
    models: [
      {
        ...
        protocol: 'openai',
        description: 'DeepSeek V4.1 Flash，默认思考，支持视觉、工具、JSON、Responses 与 Anthropic。静态估算按高峰价；空闲价（输入/输出/缓存，每百万 tokens）：1/4/0.02 元，高峰为 2 倍。',
        maxContextTokens: 1000000,
        maxOutputTokens: 393216,
        inputPricePer1MTokensRmb: 2,
        outputPricePer1MTokensRmb: 8,
        cacheHitPricePer1MTokensRmb: 0.04,
        capabilityTags: [...DEEPSEEK_V4_CAPABILITIES, 'vision'],
      ...
      },
      {
        ...
        protocol: 'openai',
        description: 'DeepSeek V4 Pro 0813，默认思考，支持工具、JSON、Responses 与 Anthropic，不支持视觉。静态估算按高峰价；空闲价（输入/输出/缓存，每百万 tokens）：4.5/13.5/0.15 元，高峰为 2 倍。',
        maxContextTokens: 1000000,
        maxOutputTokens: 393216,
        inputPricePer1MTokensRmb: 9,
        outputPricePer1MTokensRmb: 27,
        cacheHitPricePer1MTokensRmb: 0.30,
