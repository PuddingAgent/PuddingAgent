...
const agentTemplates = [
  ...
  },
  {
    ...
    capability: {
      ...
      allowFileWrite: true,
      allowNetworkAccess: true,
      allowedToolNames: ['shell', 'file_read', 'file_write', 'search_code'],
    },
  },
  {
...
const workspaceAgentTemplates: any[] = [
  { id: 1, workspaceId: 'default', templateId: 'ws-general', name: '工作空间助手', description: '默认工作空间专用助手', role: 'Service', systemPrompt: '你是默认工作空间的助手，熟悉平台内部流程。', userPromptTemplate: null, baseGlobalTemplateId: 'general-assistant', preferredProviderId: 'openai', preferredModelId: 'gpt-4o-mini', maxContextTokens: 8192, isEnabled: true, sortOrder: 0, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: 2, workspaceId: 'ws-dev-team', templateId: 'dev-coder', name: '开发团队代码助手', description: '为开发团队定制的代码精灵', role: 'Task', systemPrompt: '你是开发团队的代码助手，熟悉团队的技术栈（.NET 10 / React / TypeScript）。', userPromptTemplate: null, baseGlobalTemplateId: 'code-assistant', preferredProviderId: 'deepseek', preferredModelId: 'deepseek-chat', maxContextTokens: 32768, isEnabled: true, sortOrder: 0, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
  { id: 3, workspaceId: 'ws-trial', templateId: 'trial-simple', name: '试用版助手', description: '功能受限的试用体验助手', role: 'Service', systemPrompt: '你是试用版 AI 助手，功能有限，如需完整体验请升级套餐。', userPromptTemplate: null, baseGlobalTemplateId: 'general-assistant', preferredProviderId: 'deepseek', preferredModelId: 'deepseek-chat', maxContextTokens: 4096, isEnabled: true, sortOrder: 0, createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
];
