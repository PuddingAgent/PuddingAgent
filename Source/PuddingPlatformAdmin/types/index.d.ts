export namespace API {
  ...
  export type GET_API_CURRENT_USER_RES = {
    /** example: {"name": "Administrator", "avatar": "/admin/assets/images/me.png", "userid": "admin", "email": "admin@pudding.local", "signature": "Pudding Platform 管理控制台", "title": "系统管理员", "group": "Pudding Team", "notifyCount": 0, "unreadCount": 0} */
    data: {
      name: string;
      avatar: string;
      userid: string;
