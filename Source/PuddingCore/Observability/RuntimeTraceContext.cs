...
public sealed record RuntimeTraceContext
{
    ...
    public RuntimeTraceContext WithAgent(string? agentInstanceId, string? agentTemplateId = null) =>
        this with
        {
            AgentInstanceId = agentInstanceId ?? AgentInstanceId,
            AgentTemplateId = agentTemplateId ?? AgentTemplateId,
        };
