...
public static class BuiltInAgentTemplates
{
    public static readonly AgentTemplateDefinition WorkspaceServiceAgent = new()
    {
        ...
        Capability = new CapabilityPolicy
        {
            ...
            DefaultToolNames = ["search_tools", "search_memory", "save_memory", "manage_memory", "grep_memory",
    ...
    public static readonly AgentTemplateDefinition CodeAgent = new()
    {
        ...
        Capability = new CapabilityPolicy
        {
            ...
            AllowShellExecution = true,
            AllowNetworkAccess = true,
            DefaultToolNames = ["search_tools", "search_memory", "save_memory", "grep_memory",
                "query_sessions", "query_session_logs", "http_fetch", "file_read", "list_dir", "file_search", "search_grep",
                "spawn_sub_agent", "event_subscribe", "sleep", "goal_read", "goal_update",
                "browser_context", "browser_tabs", "browser_navigate", "browser_snapshot",
                "browser_locate", "browser_interact", "browser_wait_for",
    ...
    public static readonly AgentTemplateDefinition WorkspaceAuditAgent = new()
    {
        ...
        Capability = new CapabilityPolicy
        {
            ...
            DefaultToolNames = ["search_tools", "search_memory", "grep_memory", "query_sessions", "query_session_logs", "file_read", "list_dir",
