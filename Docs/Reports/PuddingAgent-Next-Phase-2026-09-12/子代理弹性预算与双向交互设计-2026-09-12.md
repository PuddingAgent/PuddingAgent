...
| 全局600、WorkUnit默认32/上限40/工具120及Planner小预算并存 | `SubAgentInvocationContracts.cs`、`SubAgentManager.NormalizeExecutionBudget`、`TaskExecutionPlanCompiler` | 限制散落；上轮只提600仍不足以定义灵活产品能力 |
