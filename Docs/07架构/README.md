...
[ADR-089](103ADR-089Agent统一检索与渐进展开工具链ADR.md)（Proposed）与[详细设计](../Features/Agent统一检索与渐进展开工具链设计-2026-09-13.md)：一个搜索入口聚合 Everything、代码索引与内容检索，一个展开入口统一读取/结构/关系；共享范围、证据引用、版本与预算。tgrep 为候选后端，本轮仅设计，未实施或验收。
