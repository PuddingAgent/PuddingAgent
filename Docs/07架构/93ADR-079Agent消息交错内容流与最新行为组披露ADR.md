...
> **2026-09-15 阅读密度修订**：用户反馈超长消息卡片难以阅读。本 ADR 的“正文永久可见”和“组内完整推理”调整为“正文唯一且完整保留、按需展开”；超长回合可就地收拢连续较早内容前缀，最新行为组仍保留。具体阈值与交互见实施方案 §15。此修订只改变可见性，不更改 canonical 顺序、正文源、工具配对或复制/TTS 内容。
