...
argument_hint: "探索目标，例如 '密码模块的入口和依赖关系'、'所有使用 NPOI 的文件' 或 '从 Logs 目录中找出异常线索'"
model: gpt-5.4-mini
model_reason: "Read-only exploration uses the lightweight fast model."
...
> Codex role copy of `.github/agents/explore.agent.md`.
