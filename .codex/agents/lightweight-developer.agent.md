...
argument_hint: "简单开发任务或任务ID，例如 '修复一个表单校验问题'、'实现简单 CRUD 页面' 或 'TASK-105'"
model: gpt-5.3-codex
model_reason: "Development and construction tasks use the coding-optimized model."
codex_tools: [shell_command, apply_patch, rg, tests, todo-api]
handoffs:
  - label: EscalateToDev
    agent: dev
  ...
  - label: HandoffToQA
    agent: qa
    prompt: 代码由 gpt-5.3-codex 开发，请进行独立审阅。
    send: false
  - label: HandoffToDoc
    agent: doc
...
> Codex role copy of `.github/agents/lightweight-developer.agent.md`.
