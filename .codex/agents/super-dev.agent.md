...
argument_hint: "高复杂度任务ID 或描述，例如 'TASK-200 实现 P2P 网络层|重构 Agent 核心管线'"
model: gpt-5.3-codex
model_reason: "Complex development and construction tasks use the coding-optimized model."
codex_tools: [shell_command, apply_patch, rg, tests, todo-api, subagents]
handoffs:
  ...
  - label: HandoffToQA
    agent: qa
    prompt: 代码由 gpt-5.3-codex 开发，请进行独立审阅（高复杂度变更请重点审查）。
    send: false
...
> Codex role copy of `.github/agents/super-dev.agent.md`.
